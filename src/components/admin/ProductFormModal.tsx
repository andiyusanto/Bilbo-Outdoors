  ...
  return (
    <div className="fixed inset-0 bg-black/60 z-50 flex items-center justify-center p-4">
      <div className="bg-white w-full max-w-md lg:max-w-2xl max-h-[90vh] rounded-none shadow-[8px_8px_0px_rgba(0,0,0,1)] border-4 border-black overflow-hidden flex flex-col">
        ...
        <form onSubmit={onSubmit} className="p-5 space-y-4 bg-white text-black overflow-y-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            <div className="border-2 border-black p-3.5 space-y-4">
            ...
            <div className="border-2 border-black p-3.5 space-y-4">
              <p className="text-[10px] font-black text-zinc-500 uppercase tracking-widest">Harga &amp; Stok</p>
